use Test2::V1 -ipP;
use Cancer::Ansi qw(
    set_progress_bar set_error_progress_bar set_warning_progress_bar
);
subtest 'TestSetProgress' => sub {
...
subtest 'TestSetErrorProgress' => sub {
...
subtest 'TestSetWarningProgress' => sub {
