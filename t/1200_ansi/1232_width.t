...
my @cases = (
    ...
    [ 'oscwideemoji3', "\e[31m\x{1F468}\x{200D}\x{1F469}\x{200D}\x{1F466}\e[m",            "\x{1F468}\x{200D}\x{1F469}\x{200D}\x{1F466}",      2, 2 ],
    [ 'multiemojicsi', "\x{1F468}\x{200D}\x{1F469}\x{200D}\x{1F466}\x9b38;5;1mhello\x9bm", "\x{1F468}\x{200D}\x{1F469}\x{200D}\x{1F466}hello", 7, 7 ],
    ...
    [ 'flag',               "\x{1F1F8}\x{1F1E6}",                                                         "\x{1F1F8}\x{1F1E6}",           2,  1 ],
    [ 'halfwidth',          "(\x{FF9F}",                                                                  "(\x{FF9F}",                    1,  1 ],
);
